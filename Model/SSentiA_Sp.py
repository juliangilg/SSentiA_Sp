...
class sSentiA_Sp(object):
    ...
    def apply_SSSentiA(self, df1, df2, df3, df4, df5): 
        ...
        X_1, Y_1,Z_1 = self.get_data_n_label_n_predcition(df1)
        
        
        # High Confidence Group (Bin 2)
        X_2, Y_2,Z_2 = self.get_data_n_label_n_predcition(df2)
        
        # Low Confidence Group (Bin 3)
        X_3, Y_3,Z_3 = self.get_data_n_label_n_predcition(df3)
        
        # very-Low Confidence Group (Bin 4)
        X_4, Y_4,Z_4 = self.get_data_n_label_n_predcition(df4)
       
        # Zero Confidence Group  (Bin 5)
        X_5, Y_5,Z_5 = self.get_data_n_label_n_predcition(df5)
